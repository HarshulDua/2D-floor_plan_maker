...
public class FloorPlanner extends JFrame {
    ...
    private JButton addRoomButton, addDoorButton, addWindowButton, addFurnitureButton, rotateFurnitureButton,
            deleteRoomButton;
    ...
    private void initializeToolBar() {
        ...
        // New Frame button
        newFrameButton = new JButton("New Frame", new ImageIcon("path/to/new-icon.png")); // Replace with actual icon
                                                                                          // path
    ...
    private void loadImages() {
        ...
        bedIcon = createImageIcon("bed.jpg");
        chairIcon = createImageIcon("chair.jpg");
        tableIcon = createImageIcon("table.jpg");
        sofaIcon = createImageIcon("sofa.jpg");
        diningSetIcon = createImageIcon("dining_set.jpg");
        commodeIcon = createImageIcon("commode.jpg");
        washbasinIcon = createImageIcon("washbasin.jpg");
        showerIcon = createImageIcon("shower.jpg");
        sinkIcon = createImageIcon("sink.jpg");
        stoveIcon = createImageIcon("stove.jpg");
    }
    ...
    private boolean findValidPosition(Furniture furniture, Room room) {
        ...
        for (int y = room.getY() + margin; y <= room.getY() + room.getHeight() - furniture.getHeight()
                - margin; y += stepSize) {
            for (int x = room.getX() + margin; x <= room.getX() + room.getWidth() - furniture.getWidth()
                    - margin; x += stepSize) {
                furniture.setX(x);
                furniture.setY(y);
    ...
    private ImageIcon getIconForFurniture(String type) {
        ...
        switch (type.toUpperCase()) {
            ...
            case "SOFA":
                return sofaIcon;
            case "DINING_SET":
                return diningSetIcon;
            case "COMMODE":
                return commodeIcon;
            case "WASHBASIN":
                return washbasinIcon;
            case "SHOWER":
                return showerIcon;
            case "SINK":
                return sinkIcon;
...
class Furniture implements Serializable {
    ...
    public Rectangle getBounds() {
        // For collision detection, we use the larger of width/height for rotated
        // furniture
